      ...
      <section className="relative border-b border-neutral-800 bg-gradient-to-b from-neutral-950 to-neutral-900">
        <div className="mx-auto max-w-5xl px-4 py-12 sm:py-16">
          ...
          <p className="mt-6 max-w-3xl text-neutral-300">
            Hacker Tracker is a conference information app used by tech-related
            conferences of all sizes. Our mission is to help attendees help
            themselves with accurate, up-to-date schedules and details.
          </p>
        </div>
      </section>
      ...
      <div className="mx-auto max-w-5xl px-4 py-10">
        ...
        <section aria-labelledby="who-we-are" className="mb-12">
          ...
          <p className="mt-2 max-w-3xl text-neutral-300">
            We’re a small group of friends who met at DEF CON and recognized the
            need for improved attendee communication at conferences everywhere.
          </p>
