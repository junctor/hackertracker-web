        ...
        <section aria-labelledby="contrib">
          ...
          <div className="mt-4 grid gap-4 md:grid-cols-2">
            ...
            <div className="rounded-xl border border-neutral-800 bg-neutral-900/50 p-4">
              ...
              <p className="mt-1 text-sm text-neutral-400">
                Open an issue in the relevant repo. If it spans multiple repos,
            ...
            <div className="rounded-xl border border-neutral-800 bg-neutral-900/50 p-4 md:col-span-2">
              ...
              <p className="mt-1 text-sm text-neutral-400">
                Interested in contributing? Reach out to any of us. We don’t yet
                have a formal onboarding process, but we’d love to collaborate.
              </p>
              <a
                href="https://discord.gg/jJNSZYdnF7"
                target="_blank"
